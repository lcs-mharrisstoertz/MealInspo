...
let mealsToShow = [
    ...
    Meal(nameOfMeal: "Spicy'nduja Vongole",
        imageName: "Spicy'ndujaVongole",
        description: "WITH FRESH PARSLEY & ROSÉ",
        dietaryRestrictions: "Dairy-Free"),
    
    Meal(nameOfMeal: "Sticky Hoisin Chicken",
        imageName: "StickyHoisinChicken",
        description: "WITH BLOOD ORANGE & SPRING ONION",
        dietaryRestrictions: "Dairy-Free"),
    
    Meal(nameOfMeal: "Sticky Kickin Wings",
        imageName: "StickyKickinWings",
        description: "WITH A KICK OF FRESH CHILLI, TOASTED SESAME SEEDS & TERIYAKI SAUCE",
        dietaryRestrictions: "Dairy-Free"),
    
    Meal(nameOfMeal: "Sweet & Sour Chicken Noodles",
        imageName: "Sweet&SourChickenNoodles",
        description: "WITH CHICKEN SKIN CRACKLING",
        dietaryRestrictions: "Dairy-Free"),
    
    Meal(nameOfMeal: "Sweet & Sour Stir-Fry",
        imageName: "Sweet&SourStir-Fry",
        description: "WITH LOADSA SPROUTS, PINEAPPLE & NOODLES",
        dietaryRestrictions: "Vegetarian, Vegan, Gluten-Free, Dairy-Free"),
    
    Meal(nameOfMeal: "Sweet Chicken Surprise",
        imageName: "SweetChickenSurprise",
        description: "WITH VERMOUTH & TARRAGON",
        dietaryRestrictions: "Dairy-Free, Gluten-Free"),
    
    Meal(nameOfMeal: "Thai-Style Crispy Sea Bass",
        imageName: "Thai-StyleCrispySeaBass",
        description: "WITH FRESH & ZINGY LIME, CORIANDER & SPRING ONIONS",
        dietaryRestrictions: "Dairy-Free, Gluten-Free"),
    
    Meal(nameOfMeal: "Tunisian Prawn Spaghetti",
        imageName: "TunisianPrawnSpaghetti",
        description: "WITH FRAGRANT ROSE HARISSA, ZINGY LEMON & FRESH PARSLEY",
        dietaryRestrictions: "Dairy-Free"),
    
    Meal(nameOfMeal: "Veggie Pad Thai",
        imageName: "VeggiePadThai",
        description: "WITH CRISPY FRIED EGGS, SPECIAL TAMARIND & TOFU SAUCE, PEANUT SPRINKLE",
        dietaryRestrictions: "Vegetarian, Dairy-Free, Vegan"),
